...
public class AgregarNeuropsicologo extends Command {
    ...
    public AgregarNeuropsicologo(EquipoProfesionalId equipoProfesionalId, NeuropsicologoId entityId, Nombre nombre, Email email, TarjetaProfesional tarjetaProfesional){

        this.equipoProfesionalId = equipoProfesionalId;
        neuropsicologoId = entityId;
        this.nombre = nombre;
        this.email = email;
